...
\usepackage{mathpazo} % Using Palatino
...
autopunct=true,abbreviate=false,backref=true,backend=biber,arxiv=pdf]{biblatex}
...
% Vectorial product
\newcommand{\vectorial}[2]{\ensuremath{#1\times #2}}                                       
% Gradient                                                                                 
\newcommand{\grad}[1]{\ensuremath{\vec{\nabla}#1}}
% Divergence
\let\olddiv\div
\renewcommand{\div}[1]{\ensuremath{\scalar{\vec{\nabla}}{#1}}}
% Rotor
\newcommand{\rot}[1]{\ensuremath{\vectorial{\vec{\nabla}}{#1}}}
% Matrix transpose
...
\node[draw=maincolor!60,line width=1pt,circle,fill=maincolor!25,font=\sffamily\bfseries,inner sep=2pt,outer sep=0pt] at (-15pt,0pt){\scriptsize\textcolor{maincolor}{Oss}};\end{tikzpicture}} % Orange R in a circle
...
\newlength{\minipagespace}
\setlength{\minipagespace}{2ex}
\makeatother
